...
const translations = {
  en: {
    ...
    "Hay registro digital, pero no validación fisica continua.": "There is a digital record, but no continuous physical validation.",
    ...
    "Suele ser amplio, pero poco aterrizado al comercio pequeño.": "Usually broad, but not grounded enough for small commerce.",
    "Se enfoca en perecibles, rotación, pedidos y caja diaria.": "Focuses on perishables, rotation, orders, and daily cash flow.",
    ...
    "La landing despeja dudas basicas rápido, sin sobrecargar de detalles tecnicos a un usuario no especializado.": "The landing page answers basic questions quickly, without overloading a non-specialist user with technical details.",
    ...
    "Cierre más confiable": "More reliable closing",
    "verificado": "verified"
  },
};
